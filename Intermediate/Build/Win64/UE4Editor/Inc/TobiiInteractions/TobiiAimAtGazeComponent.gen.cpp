...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTobiiAimAtGazeComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UTobiiAimAtGazeComponent_AimAtGazeAvailable, "AimAtGazeAvailable" }, // 1491842022
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTobiiAimAtGazeComponent_Statics::NewProp_FocusLayerFilters = { "FocusLayerFilters", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTobiiAimAtGazeComponent, FocusLayerFilters), METADATA_PARAMS(Z_Construct_UClass_UTobiiAimAtGazeComponent_Statics::NewProp_FocusLayerFilters_MetaData, ARRAY_COUNT(Z_Construct_UClass_UTobiiAimAtGazeComponent_Statics::NewProp_FocusLayerFilters_MetaData)) };
	...
	IMPLEMENT_CLASS(UTobiiAimAtGazeComponent, 1624098111);
